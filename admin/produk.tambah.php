...
?>
<?php
$nama_produk = $deskripsi_produk = $jenis_produk = $satuan_produk = $stok_produk = $harga_produk  = $stok_produk = $foto_produk = $simpan = "";

$nama_produk_err = $deskripsi_produk_err = $satuan_produk_err = $jenis_produk_err = $harga_produk_err  = $stok_produk_err  = $foto_produk_err = "";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  if (empty($nama_produk_err) && empty($deskripsi_produk_err) && empty($jenis_produk_err) && empty($harga_produk_err) && empty($satuan_produk_err) && empty($stok_produk_err) && empty($foto_produk_err)) {
    ...
    if (InsertProduk($nama, $nama_produk, $deskripsi_produk, $jenis_produk, $harga_produk, $satuan_produk, $stok_produk, $foto_produk, $tanggal_buat)) {
